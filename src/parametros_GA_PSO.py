...
series_df = load_and_prepare_data_global('data/processed/series_tienda47_seleccionados.csv', max_rows=None)
...
resultados_GA = open('results/metrics/parametros_GA.txt', 'w', encoding='utf-8')
resultados_GA.write("="*80 + "\n")
resultados_GA.write("RESULTADOS DE OPTIMIZACIÓN DE HIPERPARÁMETROS - ALGORITMO GENÉTICO (GA)\n")
resultados_GA.write(f"Fecha de inicio: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n")
resultados_GA.write("="*80 + "\n\n")
...
resultados_GA.write("\n" + "="*80 + "\n")
resultados_GA.write("ALGORITMO GENÉTICO (GA)\n")
resultados_GA.write("="*80 + "\n\n")
...
# ============================================
resultados_GA.write("\n" + "-"*80 + "\n")
resultados_GA.write("BUCLE 1: Variando pop_size (n_generations=10, crossover_rate=0.8, mutation_rate=0.1)\n")
resultados_GA.write("-"*80 + "\n\n")

for modelo in modelos:
    for pop_size in pop_sizes:
        resultados_GA.write(f"\n--- GA {modelo} - pop_size={pop_size} ---\n")
        ...
        registrar_resultado(resultados_GA, f"GA_pop{pop_size}", modelo, val_rmsle, val_rmse, 
...
resultados_GA.write("\n" + "-"*80 + "\n")
resultados_GA.write("BUCLE 2: Variando n_generations (pop_size=12, crossover_rate=0.8, mutation_rate=0.1)\n")
resultados_GA.write("-"*80 + "\n\n")
...
for modelo in modelos:
    for n_gen in n_generations:
        ...
        tiempo_fin = datetime.now()
        tiempo_transcurrido = tiempo_fin - tiempo_inicio
        registrar_resultado(resultados_GA, f"GA_gen{n_gen}", modelo, val_rmsle, val_rmse, 
                          hparams, tiempo_transcurrido, tiempo_fin)
        resultados_GA.write("\n")
...
resultados_GA.write("\n" + "-"*80 + "\n")
resultados_GA.write("BUCLE 3: Variando crossover_rate (pop_size=12, n_generations=10, mutation_rate=0.1)\n")
resultados_GA.write("-"*80 + "\n\n")
...
for modelo in modelos:
    for crossover_rate in crossover_rates:
        ...
        tiempo_fin = datetime.now()
        tiempo_transcurrido = tiempo_fin - tiempo_inicio
        registrar_resultado(resultados_GA, f"GA_cr{crossover_rate}", modelo, val_rmsle, val_rmse, 
                          hparams, tiempo_transcurrido, tiempo_fin)
        resultados_GA.write("\n")
...
resultados_GA.write("\n" + "-"*80 + "\n")
resultados_GA.write("BUCLE 4: Variando mutation_rate (pop_size=12, n_generations=10, crossover_rate=0.7)\n")
resultados_GA.write("-"*80 + "\n\n")
...
for modelo in modelos:
    for mutation_rate in mutation_rates:
        ...
        tiempo_fin = datetime.now()
        tiempo_transcurrido = tiempo_fin - tiempo_inicio
        registrar_resultado(resultados_GA, f"GA_mr{mutation_rate}", modelo, val_rmsle, val_rmse, 
                          hparams, tiempo_transcurrido, tiempo_fin)
        resultados_GA.write("\n")

GA_DEFAULT_MUTATION_RATE = 0.05

# Cerrar archivo de GA
resultados_GA.write("\n" + "="*80 + "\n")
resultados_GA.write(f"Fecha de finalización: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n")
resultados_GA.write("="*80 + "\n")
resultados_GA.close()
...
print("\nResultados de GA guardados en 'results/metrics/parametros_GA.txt'")

# ============================================
# OPTIMIZACION PARÁMETROS PSO 
# ============================================

resultados_PSO = open('results/metrics/parametros_PSO.txt', 'w', encoding='utf-8')
resultados_PSO.write("="*80 + "\n")
resultados_PSO.write("RESULTADOS DE OPTIMIZACIÓN DE HIPERPARÁMETROS - PARTICLE SWARM OPTIMIZATION (PSO)\n")
resultados_PSO.write(f"Fecha de inicio: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n")
resultados_PSO.write("="*80 + "\n\n")
...
resultados_PSO.write("\n" + "="*80 + "\n")
resultados_PSO.write("PARTICLE SWARM OPTIMIZATION (PSO)\n")
resultados_PSO.write("="*80 + "\n\n")
...
# ============================================
resultados_PSO.write("\n" + "-"*80 + "\n")
resultados_PSO.write("BUCLE 1: Variando n_particles (n_iterations=30, c1=1.5, c2=1.5, w=0.7)\n")
resultados_PSO.write("-"*80 + "\n\n")

for modelo in modelos:
    for n_parts in particles:
        resultados_PSO.write(f"\n--- PSO {modelo} - n_particles={n_parts} ---\n")
        tiempo_inicio = datetime.now()
        ...
        tiempo_fin = datetime.now()
        tiempo_transcurrido = tiempo_fin - tiempo_inicio
        registrar_resultado(resultados_PSO, f"PSO_part{n_parts}", modelo, val_rmsle, val_rmse, 
                          hparams, tiempo_transcurrido, tiempo_fin)
        resultados_PSO.write("\n")
...
resultados_PSO.write("\n" + "-"*80 + "\n")
resultados_PSO.write("BUCLE 2: Variando n_iterations (n_particles=15, c1=1.5, c2=1.5, w=0.7)\n")
resultados_PSO.write("-"*80 + "\n\n")
for modelo in modelos:
    for n_iter in iterations:
        ...
        tiempo_fin = datetime.now()
        tiempo_transcurrido = tiempo_fin - tiempo_inicio
        registrar_resultado(resultados_PSO, f"PSO_iter{n_iter}", modelo, val_rmsle, val_rmse, 
                          hparams, tiempo_transcurrido, tiempo_fin)
        resultados_PSO.write("\n")
...
resultados_PSO.write("\n" + "-"*80 + "\n")
resultados_PSO.write("BUCLE 3: Variando c1 y c2 (n_particles=15, n_iterations=10, w=0.7)\n")
resultados_PSO.write("-"*80 + "\n\n")
...
for modelo in modelos:
    for c1_val, c2_val in c1_c2:
        ...
        tiempo_fin = datetime.now()
        tiempo_transcurrido = tiempo_fin - tiempo_inicio
        registrar_resultado(resultados_PSO, f"PSO_c1{c1_val}_c2{c2_val}", modelo, val_rmsle, val_rmse, 
                          hparams, tiempo_transcurrido, tiempo_fin)
        resultados_PSO.write("\n")
...
resultados_PSO.write("\n" + "-"*80 + "\n")
resultados_PSO.write("BUCLE 4: Variando w (n_particles=15, n_iterations=10, c1=1.5, c2=1.5)\n")
resultados_PSO.write("-"*80 + "\n\n")
...
for modelo in modelos:
    for w_val in w:
        ...
        tiempo_fin = datetime.now()
        tiempo_transcurrido = tiempo_fin - tiempo_inicio
        registrar_resultado(resultados_PSO, f"PSO_w{w_val}", modelo, val_rmsle, val_rmse, 
                          hparams, tiempo_transcurrido, tiempo_fin)
        resultados_PSO.write("\n")

# Cerrar archivo de PSO
resultados_PSO.write("\n" + "="*80 + "\n")
resultados_PSO.write(f"Fecha de finalización: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}\n")
resultados_PSO.write("="*80 + "\n")
resultados_PSO.close()
...
print("\nResultados de PSO guardados en 'results/metrics/parametros_PSO.txt'")
