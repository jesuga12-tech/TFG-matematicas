...
- Entrena modelos básicos (LSTM, CNN, TCN)
...
# =========================================
# ENTRENAR MODELOS BÁSICOS (LSTM, CNN, TCN)
# =========================================

print("\n" + "="*80)
print("ENTRENANDO MODELOS BÁSICOS (LSTM, CNN, TCN)")
print("="*80)
...
# LSTM con hiperparámetros fijos
lstm_hparams = {
    "lstm_units": 64,
    "dropout": 0.2,
    "lr": 1e-3
}
lstm_model = build_lstm_model(input_shape, lstm_hparams, n_stores, n_items)
...
resultados_file = open('results/metrics/resultados_optimizacion_hiperparametros_val.txt', 'w', encoding='utf-8')
...
output_file = 'results/metrics/resultados_modelos_optimizados.xlsx'
...
# ============================================
# Ejecutar cada modelo con 30 semillas diferentes para tests estadísticos (Friedman y Nemenyi)

print("\n" + "="*80)
print("EVALUACIÓN ESTADÍSTICA CON 30 SEMILLAS")
print("="*80)
...
for seed_idx, seed in enumerate(RANDOM_SEEDS, 1):
    ...
    for modelo in modelos:
        ...
        if modelo == "cnn":
            ...
            model = build_lstm_model(input_shape, best_hparams[modelo], n_stores, n_items)
        elif modelo == "tcn":
...
output_file = 'results/metrics/resultados_estadisticos_30_semillas.xlsx'
